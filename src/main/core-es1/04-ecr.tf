locals {
  repository_names = [
    ...
    "interop-be-kpi-domains-readmodel-checker",
    "interop-be-in-app-notification-dispatcher",
    ...
    "interop-be-notification-tenant-lifecycle-consumer",
    "interop-be-notifier",
    ...
    "interop-be-selfcare-client-users-updater",
