...
# module "be_refactor_certified_mail_queue_monitoring" {
#   source     = "./modules/queue-monitoring"
#   depends_on = [module.be_refactor_certified_mail_queue]
#
#   env                     = var.env
#   region                  = var.aws_region
#   queue_name              = module.be_refactor_certified_mail_queue[0].queue_name
#   alarm_threshold_seconds = "1800" # 30 minutes
